...
const Orders = () => {
    ...
    function changeWaiterForOrder(){
        ...
        var url = "http://localhost:" + port + "/waiter/update/" + changeWaiter.id
        axios.put(url, {
    ...
    function changeSingleOrder(){
        ...
        var url = "http://localhost:" + port + "/order/update/" + changeOrder.id
    ...
    function addSingleOrder(){
        ...
        var url = "http://localhost:" + port + "/order/create"
        axios.post(url, {
    ...
    function deleteSingleOrder(id){
        var url = "http://localhost:" + port + "/order/delete/" + id
        axios.delete(url, {
